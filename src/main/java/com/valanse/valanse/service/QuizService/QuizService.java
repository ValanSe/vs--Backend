...
public interface QuizService {
    ...
    void saveUserAnswer(HttpServletRequest httpServletRequest, UserAnswerDto userAnswer, List<String> categories) throws InvalidOptionException; // 클라이언트의 답변을 데이터베이스에 저장
}
